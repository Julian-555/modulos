...
<body>
    <div class="container shadow p-3 mb-5 bg-body rounded ">
        <form action="" name="modificarusuario" method="POST">
            <table  class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                             <td>id</td>   
                             <td><input class="form-control form-control-sm" type="text" name="id_usuario" id="id_usuario" value="<?php echo $arreglo2[0]  ?>" placeholder="El Codigo es Asignado por el Sistema" aria-label=".form-control-sm example" ></td>   
                        </tr>
                        <tr>
                            <td>nombres </td>   
