        ...
        <form action="" name="usuario" method="POST">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm shadow p-3 mb-5 bg-body rounded">
                    <thead>
                        <tr>
                            <td colspan="10" class="p-3 mb-2 bg-primary text-white"><h5>Lista de usuarios</h5></td>
                        </tr>
                    </thead>
                    <tbody >
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php 
                                    if($arreglo2[0]<>''){
                                        echo"modificarusuario.php?key=".urlencode($arreglo2[0]);
                                    }
                                ?>">
                            ...
                            <a href="<?php 
                                    if($arreglo2[0]<>''){
                                        echo"eliminarusuario.php?key=".urlencode($arreglo2[0]);
                                    }
                                    ?>">
